!function (e, t) {
    ...
    return function (e) {
        ...
        !function (e) {
            ...
            e.exports = '<h3>Localização do ponto</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-export exportmarkup">Exportar</a></li> <li><a href=# class="js-zoomto zoomto">Centralizar neste local</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> '
        }, function (e, t, r) {
            e.exports = '<h3>Medição linear</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-export exportmarkup">Exportar</a></li> <li><a href=# class="js-zoomto zoomto">Centralizar nesta linha</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> '
        }, function (e, t, r) {
            e.exports = '<h3>Medição de área</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetro</p> <ul class=tasks> <li><a href=# class="js-export exportmarkup">Exportar</a></li> <li><a href=# class="js-zoomto zoomto">Centrar nesta área</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> '
        }])
    }, function (e, t, r) {
        var n = r(6);
        ...
        "    border: 0;\n" +
        "    text-align: left;\n" +
        "    background-image: url('data:image/png;base64,');\n" +
        "    background-repeat: no-repeat;\n" +
        "    background-position: 0 50%;\n" +
        "    background-size: 12px 12px;\n" +
        "    color: #17c671;\n" +
